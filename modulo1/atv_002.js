...
if (!numeroInteiro.isNaN && numeroInteiro >= 0) {
    ...
    if (numeroInteiro == 0) {
        ...
        while (stringNumero[counterCaracteres] !== undefined) {
            console.log(`Caractere ${counterCaracteres + 1} - ${stringNumero[counterCaracteres]}`);
            counterCaracteres++;
        }
    }
    console.log(`O número ${stringNumero} tem ${counterCaracteres} caractere(s)`);
} else {
